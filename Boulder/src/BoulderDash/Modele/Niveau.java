...
public class Niveau {
	...
	/**
	 * tableau de mise à jour, contient les Cases susceptibles d'être
	 * modifiées au prochain cycle
	 */
	private List<Case> UpTable;

	/**
	 * crée un Niveau de 60*40 avec le personnage en haut à gauche et la
	...
	/**
	 * insère un Rocher à la position indiquée en argument et le rajoute dans
	 * la UpTable
	 * 
	 * @param x
	 *            position en x
	...
	/**
	 * insère un diamant à la position indiquée en argument et le rajoute
	 * dans la UpTable
	 * 
	 * @param x
	 *            position en x
	...
	/**
	 * insère un Papillon à la position indiquée en argument et le rajoute
	 * dans la UpTable
	 * 
	 * @param x
	 *            position en x
	...
	/**
	 * 
	 * ajoute dans la table de mise à jour les cases dans le rectangle de 2*3
	 * au dessus de la position transmise
	 */
	...
	/**
	 * trie la table de mise à jour, les cases les plus basses sont
	 * prioritaires par rapport aux plus élevées
	 */
	...
	/**
	 * récupère le nombre de diamants nécessaires pour finir le niveau,
	...
	public void exporter(String niveau) {
		...
		try {
			...
			writer = new BufferedWriter(new OutputStreamWriter(
					new FileOutputStream("niveaux/" + niveau + ".csv"),
					"utf-8"));
