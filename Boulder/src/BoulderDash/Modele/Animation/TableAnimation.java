...
public class TableAnimation {
	...
	public static Animation getPapillon() {
		...
		if (tableAnimations.get(ChoixAnimation.Papillon) == null) {
			...
			tableAnimations.put(ChoixAnimation.Papillon,
					new Animation(papillon, Variables.VITESSE_ANIM));
		}
	...
	private static Animation getPersonnageMarcheDroite() {
		if (tableAnimations
				.get(ChoixAnimation.Personnage_Marche_Droite) == null) {
	...
	private static Animation getPersonnageMarcheGauche() {
		if (tableAnimations
				.get(ChoixAnimation.Personnage_Marche_Gauche) == null) {
			Sprite spritePersonnage = new Sprite("rockford");
	...
	private static Animation getPersonnageMarcheHaut() {
		if (tableAnimations
				.get(ChoixAnimation.Personnage_Marche_Haut) == null) {
			Sprite spritePersonnage = new Sprite("rockford");
	...
	private static Animation getPersonnageDeboutDroite() {
		if (tableAnimations
				.get(ChoixAnimation.Personnage_Debout_Droite) == null) {
			Sprite spritePersonnage = new Sprite("rockford");
	...
	private static Animation getPersonnageDeboutGauche() {
		if (tableAnimations
				.get(ChoixAnimation.Personnage_Debout_Gauche) == null) {
			Sprite spritePersonnage = new Sprite("rockford");
	...
	private static Animation getPersonnageDeboutHaut() {
		if (tableAnimations
				.get(ChoixAnimation.Personnage_Debout_Haut) == null) {
			Sprite spritePersonnage = new Sprite("rockford");
	...
	private static Animation getPersonnageIdle() {
		if (tableAnimations.get(ChoixAnimation.Personnage_Idle) == null) {
			...
			tableAnimations.put(ChoixAnimation.Personnage_Idle,
					new Animation(idling, Variables.VITESSE_IDLE));
		}
	...
	private static Animation getPersonnageMort() {
		if (tableAnimations.get(ChoixAnimation.Personnage_Mort) == null) {
			...
			tableAnimations.put(ChoixAnimation.Personnage_Mort,
					new Animation(mort, Variables.VITESSE_ANIM));
		}
	...
	public static Animation getBoue() {
		if (tableAnimations.get(ChoixAnimation.Boue) == null) {
			...
			tableAnimations.put(ChoixAnimation.Boue,
					new Animation(dirt, Variables.VITESSE_ANIM));
		}
	...
	public static Animation getDiamant() {
		if (tableAnimations.get(ChoixAnimation.Diamant) == null) {
			...
			tableAnimations.put(ChoixAnimation.Diamant,
					new Animation(diamond, Variables.VITESSE_ANIM));
		}
	...
	public static Animation getRocher() {
		if (tableAnimations.get(ChoixAnimation.Rocher) == null) {
			...
			BufferedImage[] rocher = { spriteRocher.getSprite(0, 0),
					spriteRocher.getSprite(0, 0), spriteRocher.getSprite(0, 0),
					spriteRocher.getSprite(0, 0) };
			tableAnimations.put(ChoixAnimation.Rocher,
					new Animation(rocher, Variables.VITESSE_ANIM));
		}
	...
	public static Animation getMur() {
		if (tableAnimations.get(ChoixAnimation.Mur) == null) {
			...
			tableAnimations.put(ChoixAnimation.Mur,
					new Animation(wall, Variables.VITESSE_ANIM));
		}
	...
	public static Animation getMurMagique() {
		if (tableAnimations.get(ChoixAnimation.Mur_Magique) == null) {
			...
			tableAnimations.put(ChoixAnimation.Mur_Magique,
					new Animation(wall, Variables.VITESSE_ANIM));
		}
	...
	public static Animation getVide() {
		if (tableAnimations.get(ChoixAnimation.Vide) == null) {
			...
			tableAnimations.put(ChoixAnimation.Vide,
					new Animation(dirtBack, Variables.VITESSE_ANIM));
		}
