...
public abstract class Case implements Interactions, Refresh {
	...
	/**
	 * constructeur, crée une case qui peut être vide avec sa position interne
	 * à x,y
	 * 
	 * @param x
	 * @param y
	...
	/**
	 * fonction permettant de savoir si la priorité de la case est supérieure
	 * à celle d'une autre ; les cases les plus basses dans le tableau sont les
	 * plus prioritaires
	 */
	...
	/**
	 * fonction d'interaction avec un personnage, est appelé quand un
	 * personnage arrive vers une case, retourne false par défaut
	 */
	@Override
