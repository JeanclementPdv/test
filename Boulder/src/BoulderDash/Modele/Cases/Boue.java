...
public class Boue extends Case {
	 ...
	 * boue, on insère du vide sur l'ancienne position du personnage
	 * (écrasement de la boue), on déclenche l'insertion en uptable de cases
	 * potentielement affectées par le changement
	 */
	@Override
